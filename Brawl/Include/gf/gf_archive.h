...
public:
    ...
    void readFileRequest(char* filePath, HeapType heapType, int param_4, int isCompressed, HeapType decompressHeapType);
    int readFile(char* filePath, HeapType heapType);
    ~gfArchive();
